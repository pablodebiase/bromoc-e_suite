...
do i = 1, nbond
  ...
  if (Qforces) then
    ...
    f1=de*v1
    floc(isite1)%x = floc(isite1)%x + f1(1)
    floc(isite1)%y = floc(isite1)%y + f1(2)
    floc(isite1)%z = floc(isite1)%z + f1(3)
    floc(isite2)%x = floc(isite2)%x - f1(1)
    floc(isite2)%y = floc(isite2)%y - f1(2)
...
do i = 1, nangle
  ...
  if (Qforces) then
    ...
    floc(isite1)%y = floc(isite1)%y + f1(2)
    floc(isite1)%z = floc(isite1)%z + f1(3)
    floc(isite2)%x = floc(isite2)%x - (f1(1)+f2(1))
    floc(isite2)%y = floc(isite2)%y - (f1(2)+f2(2))
    floc(isite2)%z = floc(isite2)%z - (f1(3)+f2(3))
    floc(isite3)%x = floc(isite3)%x + f2(1)
    floc(isite3)%y = floc(isite3)%y + f2(2)
...
do i = 1, ndihe
  ...
  if (Qforces) then
    ...
    floc(isite1)%y = floc(isite1)%y + f1(2)
    floc(isite1)%z = floc(isite1)%z + f1(3)
    floc(isite2)%x = floc(isite2)%x + f2(1)
    floc(isite2)%y = floc(isite2)%y + f2(2)
    floc(isite2)%z = floc(isite2)%z + f2(3)
    floc(isite3)%x = floc(isite3)%x + f3(1)
    floc(isite3)%y = floc(isite3)%y + f3(2)
    floc(isite3)%z = floc(isite3)%z + f3(3)
    floc(isite4)%x = floc(isite4)%x + f4(1) 
    floc(isite4)%y = floc(isite4)%y + f4(2)
